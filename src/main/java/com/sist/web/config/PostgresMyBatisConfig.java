...
@Configuration
@MapperScan(
		basePackages="com.sist.web.mapper.postgres", 
...
public class PostgresMyBatisConfig {
	...
	public SqlSessionFactory postgresSqlSessionFactory(@Qualifier("postgresDataSource")DataSource dataSource) throws Exception{
		...
		factory.setMapperLocations(Objects.requireNonNull(new PathMatchingResourcePatternResolver().getResources("classpath*:/mapper/postgres/*.xml")));
